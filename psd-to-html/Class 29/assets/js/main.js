(function ($) {
    ...
    jQuery(document).ready(function($){
        ...
        $('.search-trigger').on('click',function(){
            $('.search-box input, .search-trigger-3, .off-canvas-menu-shade-2').addClass("active");
        });
        $('.off-canvas-menu-shade-2').on('click',function(){
            $('.search-box input, .search-trigger-3, .off-canvas-menu-shade-2').removeClass("active");
        });
        ...
        $('.boxed-layout').on('click', function(){
            $('body').addClass('box-layout').removeClass('wide-layout');
            $('.layout-changer span').removeClass('active');
            $(this).addClass('active');
        });
        $('.wide-layout').on('click', function(){
            $('body').addClass('wide-layout').removeClass('box-layout');
            $('.layout-changer span').removeClass('active');
            $(this).addClass('active');
        });
